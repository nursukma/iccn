...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
        ...
        <div class="sidebar-brand-text mx-3">ICCN</div>
    </a>
    ...
    <li class="nav-item">
        <a class="nav-link" href="#">
            ...
            <span>Aksi Bersama</span>
        </a>
    </li>

    <li class="nav-item">
        <a class="nav-link" href="#">
            <i class="fas fa-fw fa-solid fa-camera-retro"></i>
            <span>Media ICCN</span>
        </a>
    </li>
    ...
    <li class="nav-item">
        <a class="nav-link" href="#">
            ...
            <span>Materi ICCN</span>
        </a>
    </li>

    <li class="nav-item">
        <a class="nav-link" href="#">
            <i class="fas fa-fw fa-solid fa-feather"></i>
            <span>Prinsip Kota</span>
        </a>
    </li>
    ...
    <li class="nav-item">
        <a class="nav-link" href="#">
            ...
            <span>Koordinator Organisasi</span>
        </a>
    </li>
    <!-- Divider -->
    <hr class="sidebar-divider">
    ...
    <li class="nav-item">
        <a class="nav-link" href="tables.html">
            <i class="fas fa-fw fa-solid fa-wrench"></i>
            <span>Situs</span>
        </a>
    </li>
