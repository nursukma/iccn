...
@section('content')
    <main class="main" id="main">
        <div class="pagetitle">
            <h1>Form Pengurus Organisasi</h1>
        </div>
            ...
            <div class="col-xl-12 col-lg-10 mx-auto">
                <div class="card shadow mb-4">
                    ...
                    <form class="form-add row g-2 needs-validation"
                        action="{{ $action == 'add' ? route('pengurus.store') : route('pengurus.update', $pengurus->id) }}"
                            ...
                            <div class="col-12">
                                <div class="col-md-6 mt-2">
                                    ...
                                    <input type="text" class="form-control" id="floatingName" placeholder="Judul"
                                        name="title" value="{{ $action == 'edit' ? $pengurus->title : '' }}">
                                </div>
                                <div class="col-12 mt-2">
                                    <label for="floatingEmail">Deskripsi</label>

                                    <input type="hidden" name="desc"
                                        value="{{ $action == 'edit' ? $pengurus->desc : '' }}">
